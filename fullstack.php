                ...
                <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            ...
                            <p class="pt-1"><i class="fa-solid fa-check mx-2" ></i>You'll be able to pick one Technology of the Backend to choose which one you want to learn.</p>
