            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            ...
                            <div class="lot px-2">
                            <p class="pt-3"><i class="fa-solid fa-check mx-2" ></i>You'll be able to understand the Introduction to Web Development</p>
                            ...
                            <p class="pt-3"><i class="fa-solid fa-check mx-2" ></i>You'll be able to understand VERSION CONTROL[GIT AND GIT HUB]</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="course-item bg-light mt-3">
                        <img src="https://img-c.udemycdn.com/course/750x422/4925142_c0ab.jpg" alt="" class="img-fluid h-100 w-100">
                        <img src="https://fiverrbox.com/wp-content/uploads/2022/08/frontend-web-developer-88ea89ec.jpeg" alt="" class="img-fluid w-100 h-100">
                    </div>
                </div>
            </div>
