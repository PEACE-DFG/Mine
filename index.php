          ...
          <div class="container">
            <div class="row justify-content-start">
              <div class="col-sm-10 col-lg-8">
                ...
                <p class="fs-5 text-white mb-4 pb-2">Learn all you need with us at CODEMaster Academy,Get Certified
                </p>
        ...
        <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="service-item text-center pt-3">
            <div class="p-4">
              ...
              <p style="font-size: 12px;">We offer online classes globally all over the world, Not only in Nigeria
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
          <div class="service-item text-center pt-2">
            <div class="p-4">
              ...
              <p style="font-size: 12px;">We also offer a wide range of documents on topics concerning web development
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="row g-3">
            <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
              <a class="position-relative d-block overflow-hidden" href="">
                <img class="img-fluid h-50" src="img/8.jpg" alt="">
        ...
        <div class="testimonial-item text-center">
          ...
          <div class="testimonial-text bg-light text-center p-4">
            <p class="mb-0">To my tutor.CODEMaster
              ...
              people.
              U know that our country could have be more better if we have someone like u around us because ur
              teaching
        ...
        <div class="testimonial-item text-center">
          ...
          <div class="testimonial-text bg-light text-center p-4">
            <p class="mb-0">Your pedagogical prowess is of the highest order, and your capacity to motivate me to
              further cultivate my skills is truly remarkable.I express my gratitude for your outstanding
              companionship,
              Sir. Our friendship holds immense value in my esteem.CODEMaster web development courses offer
              flexibility,
        ...
        <div class="testimonial-item text-center">
          ...
          <div class="testimonial-text bg-light text-center p-4">
            <p class="mb-0">CODEMaster courses provide flexible, cost-effective access to current industry
              knowledge.Students value interactive, practical learning, networking opportunities, and community
              support.
    ...
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i><small>School Road Osun State University</small>
          </p>
